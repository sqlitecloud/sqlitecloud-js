...
import { CHINOOK_DATABASE_URL, getChinookDatabase, LONG_TIMEOUT } from '../../../test/shared'
...
describe('pubSub', () => {
  it(
    ...
    async () => {
      ...
      const pubSub = new PubSubClient(connection)
      ...
      try {
        ...
        await pubSub.create(channelName, false)
        ...
        await pubSub.notify(channelName, message)
